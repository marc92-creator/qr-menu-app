...
export const FOOD_IMAGE_LIBRARY: FoodImageEntry[] = [
  ...
  },
  {
    id: 'leberkaese',
    keywords: [
      'leberkäse', 'leberkaese', 'leberkäs', 'leberkas',
      'fleischkäse', 'fleischkaese', 'fleischkas',
      'wurstkäse', 'bayerischer leberkäse',
      'leberkässemmel', 'leberkäsbrötchen'
    ],
  ...
  {
    id: 'gruener-tee',
    keywords: ['grüner tee', 'gruener tee', 'green tea', 'matcha tee', 'sencha', 'gruentee', 'gruener'],
    image: '/food-images/gruener-tee.svg',
    label: 'Grüner Tee',
    category: 'getraenke',
  },
  {
    id: 'schwarzer-tee',
    keywords: ['schwarzer tee', 'black tea', 'earl grey', 'english breakfast', 'ceylon', 'schwarztee', 'assam', 'darjeeling'],
    image: '/food-images/schwarzer-tee.svg',
    label: 'Schwarzer Tee',
    category: 'getraenke',
  },
  {
    id: 'jasmin-tee',
    keywords: ['jasmin tee', 'jasmine tea', 'jasmintee', 'jasmin'],
    image: '/food-images/jasmin-tee.svg',
    label: 'Jasmin Tee',
    category: 'getraenke',
  },
  {
